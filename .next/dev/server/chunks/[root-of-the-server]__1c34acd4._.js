...
async function POST(req) {
    ...
    try {
        ...
        db.prepare(`
            ...
            VALUES (?, ?, ?, ?, ?, ?)
        `).run(name, price, duration, JSON.stringify(features), is_popular ? 1 : 0, is_active ? 1 : 0);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
async function PUT(req) {
    ...
    try {
        ...
        db.prepare(`
            ...
            WHERE id = ?
        `).run(name, price, duration, JSON.stringify(features), is_popular ? 1 : 0, is_active ? 1 : 0, id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1c34acd4._.js.map