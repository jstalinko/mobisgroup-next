...
"[project]/src/app/api/dramabox/dubindo/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const UPSTREAM_API = (("TURBOPACK compile-time value", "https://api.sansekai.my.id/api") || "https://api.sansekai.my.id/api") + "/dramabox";
async function GET(request) {
    const searchParams = request.nextUrl.searchParams;
    const classify = searchParams.get("classify") || "terbaru";
    const page = searchParams.get("page") || "1";
    try {
        const response = await fetch(`${UPSTREAM_API}/dubindo?classify=${classify}&page=${page}`, {
            cache: 'no-store'
        });
        if (!response.ok) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const filteredData = Array.isArray(data) ? data.filter((item)=>item && item.bookId) : [];
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["encryptedResponse"])(filteredData);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1f49d9a2._.js.map