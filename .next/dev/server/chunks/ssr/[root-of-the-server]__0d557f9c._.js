...
function Header() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const checkAuth = async ()=>{
            ...
            const token = cookies.find((row)=>row.startsWith('auth_token='));
            if (token) {
                setIsLoggedIn(true);
                // We could decode the JWT here to check role, or just assume if they are on /admin they are admin
                // For header, let's just see if they have a token
                try {
                    // Simple way to check if admin without verifying signature on client
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0d557f9c._.js.map