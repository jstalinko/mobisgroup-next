...
export function Header({ initialIsLoggedIn = false, initialIsAdmin = false }: HeaderProps) {
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            {isLoggedIn ? (
              ...
              <Link href="/login" className="p-2.5 rounded-xl hover:bg-muted/50 transition-colors border border-white/10">
